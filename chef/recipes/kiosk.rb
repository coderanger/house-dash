...
# Removed `firefox` from this list because it has to be installed from an old version for now.
package %w{xorg lightdm matchbox x11-xserver-utils unclutter xdotool}

# Install RKisok
####### Can't use this with Firefox 57, sigh.
